...
mkdir -p ${outdir}
python type-based/sgns.py data/${language}/corpus1/uses/modified_corpus.txt.gz ${outdir}/mat1 10 300 5 None 39 5
python type-based/sgns.py data/${language}/corpus2/uses/modified_corpus.txt.gz ${outdir}/mat2 10 300 5 None 39 5 
