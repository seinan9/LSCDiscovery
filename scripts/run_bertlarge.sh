...
outdir=output/${language}/bertlarge/${identifier}
resdir=results/${language}/bertlarge/${identifier}
...
do  
    echo "${line}"
    python3.8 token-based/bert.py -l large_uses/${language}/corpus1/${line}.csv ${outdir}/vectors_corpus1/${line} ${language} ${type}
    python3.8 token-based/bert.py -l large_uses/${language}/corpus2/${line}.csv ${outdir}/vectors_corpus2/${line} ${language} ${type}
...
# Compute Spearman 
python3.8 evaluation/spr.py data/${language}/truth/graded.txt ${resdir}/apd.txt 1 1 >> ${resdir}/spr_apd.txt
python3.8 evaluation/spr.py data/${language}/truth/graded.txt ${resdir}/cos.txt 1 1 >> ${resdir}/spr_cos.txt

# Clean up directory 
rm -r output/${language}/bertlarge/${identifier}
