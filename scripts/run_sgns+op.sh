...
#measure CD
mkdir -p ${resdir}
python modules/cd.py -f -d data/${language}/targets.txt ${outdir}/mat1ca ${outdir}/mat2ca ${resdir}/cd.txt


#evaluate with SPR
python modules/spr.py data/${language}/truth/graded.txt ${resdir}/cd.txt graded.txt cd.txt 1 1 >> ${resdir}/spr.txt
