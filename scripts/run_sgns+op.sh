...
python measures/cd.py ${outdir}/mat1ca ${outdir}/mat2ca data/${language}/targets.txt ${resdir}/cd.tsv

# Evaluate with SPR
spr=$(python evaluation/spr.py data/${language}/truth/graded.txt ${resdir}/cd.tsv 1 1)
printf "%s\n" "${spr}" >> ${resdir}/spr.tsv
