...
- Sinan Kurtyigit, Maike Park, Dominik Schlechtweg, Jonas Kuhn, Sabine Schulte im Walde. 2021. [Lexical Semantic Change Discovery](https://arxiv.org/abs/2106.03111). Proceedings of the Joint Conference of the 59th Annual Meeting of the Association for Computational Linguistics and the 11th International Joint Conference on Natural Language Processing.
...
| `<max_samples>` | Max. number of samples to be stored for annotation | 50 | 50 |
...
| `<max_samples>` | Max. number of usages to be stored for annotation | 50 | 50 |
